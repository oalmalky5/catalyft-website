...
import ScaleFaq from '../../../components/ScaleFaq'; // change to '@/components/ScaleFaq' if you use path aliases
      ...
      <section className="bg-black text-white">
        <div className="mx-auto max-w-6xl px-6 py-24 text-center">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <a
              href="mailto:hello@catalyft.sa?subject=Scale%20in%20Saudi%20Discovery%20Call"
